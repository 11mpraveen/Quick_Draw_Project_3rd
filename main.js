...
document.getElementById("to_be_drawn").innerHTML = "sketch to be drawn : " + quick_draw_data_set[random_num];
...
document.getElementById("d_time").innerHTML = "time:" + Math.floor(timer_counter);
